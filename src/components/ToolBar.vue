...
const props = defineProps<{
  editableContainer: HTMLDivElement | undefined;
  canUndo: boolean;
  canRedo: boolean;
}>();
...
const copyHTML = () => {
  if (props.editableContainer !== undefined)
    navigator.clipboard.writeText(props.editableContainer.innerHTML);
};
